...
const Input: FC<InputProps> = ({
  ...
  if (disabled || (select && readOnly)) {
    ...
    inputClasses += ` text-gray-700 border-gray-300 bg-gray-50 cursor-default focus:border-brand-300 focus:ring-brand-500/20 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:focus:border-brand-800`;
  } else if (error) {
