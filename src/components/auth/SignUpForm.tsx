        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            {/* <p className="text-sm text-gray-500 dark:text-gray-400">
              Enter user details to create a new account for the SafulPay
              Dashboard.
            </p> */}
          </div>
          <div>
            {/* <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button
                disabled
                className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 opacity-50 cursor-not-allowed"
              >
                <svg
                  width="20"
                  height="20"
