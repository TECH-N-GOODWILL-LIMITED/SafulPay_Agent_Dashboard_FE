          ...
          <ComponentCard title={`Business Info`}>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <div
                  className={`relative h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-500  ${
                    !!error && !model
                      ? "border-error-500"
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`dz-message flex flex-col items-center m-0! upload ${
