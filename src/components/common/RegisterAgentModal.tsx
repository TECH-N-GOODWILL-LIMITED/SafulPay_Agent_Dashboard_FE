...
const RegisterAgentModal: React.FC<RegisterAgentModalProps> = ({
  ...
  return (
    <div
      className={`relative w-full max-w-[700px] max-h-[80vh] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11 ${className}`}
    >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  First Name <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="text"
                  id="firstName"
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Last Name <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="text"
                  id="lastName"
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  User Name <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="text"
                  id="userName"
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Business Name <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="text"
                  id="businessName"
              ...
              <div className="relative col-span-2 lg:col-span-1">
                <Label>
                  ID Type <span className="text-error-500 ml-2">*</span>
                </Label>
                <div
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  ID Image <span className="text-error-500 ml-2">*</span>
                </Label>
                <input
                  type="file"
                  id="idImage"
              ...
              <div className="col-span-2">
                <Label>
                  Address <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="text"
                  id="businessAddress"
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Business Image <span className="text-error-500 ml-2">*</span>
                </Label>
                <input
                  type="file"
                  id="businessImage"
              ...
              <div className="relative col-span-2 lg:col-span-1">
                <Label>
                  Model <span className="text-error-500 ml-2">*</span>
                </Label>
                <div
                  className={`relative h-11 w-full rounded-lg border px-4 py-2.5 text-sm text-gray-800 bg-transparent border-gray-300 shadow-theme-xs flex items-center justify-between cursor-pointer dark:border-gray-700 dark:text-white/90 ${
                    !!error && !model
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Latitude <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="number"
                  id="latitude"
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Longitude <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="number"
                  id="longitude"
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Residual Amount <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="number"
                  id="residualAmount"
              ...
              <div className="relative col-span-2 lg:col-span-1">
                <Label>
                  Status <span className="text-error-500 ml-2">*</span>
                </Label>
                <div
                  className={`relative h-11 w-full rounded-lg border px-4 py-2.5 text-sm text-gray-800 bg-transparent border-gray-300 shadow-theme-xs flex items-center justify-between cursor-pointer dark:border-gray-700 dark:text-white/90 ${
                    !!error && !status
              ...
              <div className="col-span-2 lg:col-span-1">
                <Label>
                  Marketer ID <span className="text-error-500 ml-2">*</span>
                </Label>
                <Input
                  type="number"
                  id="marketerId"
              ...
              <div className="relative col-span-2 lg:col-span-1">
                <Label>
                  Type <span className="text-error-500 ml-2">*</span>
                </Label>
                <div
                  className={`relative h-11 w-full rounded-lg border px-4 py-2.5 text-sm text-gray-800 bg-transparent border-gray-300 shadow-theme-xs flex items-center justify-between cursor-pointer dark:border-gray-700 dark:text-white/90 ${
                    !!error && !type
